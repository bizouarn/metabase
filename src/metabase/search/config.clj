...
(defmethod columns-for-model "card"
  [_]
  (conj default-columns :collection_id :trashed_directly :collection_position :dataset_query :display :creator_id
...
(defmethod columns-for-model "dashboard"
  [_]
  (conj default-columns :trashed_directly :collection_id :collection_position :creator_id bookmark-col
        [:collection.name :collection_name]
        [:collection.type :collection_type]
        [:collection.authority_level :collection_authority_level]))
